...
two players to take turns rolling a die. The first player to reach 50 points wins the game.
\begin{figure}[H]
\centering
...
\begin{itemize}
    ...
    \item Place a brown jumper wire between \textbf{J28} and the top negative rail.
\end{itemize}
