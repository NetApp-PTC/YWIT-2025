\chapter{Project 2: LED Party}

\section{Overview}
This project adds on to the lessons from the last project. In addition to our single LED, we will add a
button and several more LEDs. This will let us write some code that can control them in interesting ways
