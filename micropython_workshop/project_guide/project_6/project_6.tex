...
\begin{itemize}
    ...
    \item Place a resistor between \textbf{G28} and the top negative rail.
    \item Finally, place a resistor between \textbf{G21} and the top negative rail.
\end{itemize}
...
\begin{itemize}
    \item Attach the antenna to the microcontroller by plugging the gold end of its wire into the socket in the bottom of
    ...
    \item Finally, place a green jumper wire between \textbf{J30} and \textbf{J7}. This will provide the signal to move to the next screen.
\end{itemize}
